...
public class realsenseJNI {
  ...
  public final static native int PXC3DScan_CUID_get();
  public final static native long PXC3DSeg_AcquireSegmentedImage(long jarg1, PXC3DSeg jarg1_);
  public final static native int PXC3DSeg_CUID_get();
  public final static native int PXCAddRef_CUID_get();
  public final static native int PXCAddRef_AddRef(long jarg1, PXCAddRef jarg1_);
  public final static native int PXCAudio_CUID_get();
  ...
  public final static native int PXCAudioSource_CUID_get();
  ...
  public final static native int PXCCapture_CUID_get();
  ...
  public final static native int PXCCapture_Device_CUID_get();
  public final static native int PXCCapture_Device_POWER_LINE_FREQUENCY_DISABLED_get();
  public final static native int PXCCapture_Device_POWER_LINE_FREQUENCY_50HZ_get();
  public final static native int PXCCapture_Device_POWER_LINE_FREQUENCY_60HZ_get();
  public final static native int PXCCapture_Device_MIRROR_MODE_DISABLED_get();
  public final static native int PXCCapture_Device_MIRROR_MODE_HORIZONTAL_get();
  public final static native int PXCCapture_Device_IVCAM_ACCURACY_FINEST_get();
  public final static native int PXCCapture_Device_IVCAM_ACCURACY_MEDIAN_get();
  public final static native int PXCCapture_Device_IVCAM_ACCURACY_COARSE_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_EXPOSURE_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_BRIGHTNESS_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_CONTRAST_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_SATURATION_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_HUE_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_GAMMA_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_WHITE_BALANCE_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_SHARPNESS_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_BACK_LIGHT_COMPENSATION_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_GAIN_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_POWER_LINE_FREQUENCY_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_FOCAL_LENGTH_MM_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_FIELD_OF_VIEW_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_FOCAL_LENGTH_get();
  public final static native int PXCCapture_Device_PROPERTY_COLOR_PRINCIPAL_POINT_get();
  public final static native int PXCCapture_Device_PROPERTY_DEPTH_LOW_CONFIDENCE_VALUE_get();
  public final static native int PXCCapture_Device_PROPERTY_DEPTH_CONFIDENCE_THRESHOLD_get();
  public final static native int PXCCapture_Device_PROPERTY_DEPTH_UNIT_get();
  public final static native int PXCCapture_Device_PROPERTY_DEPTH_FOCAL_LENGTH_MM_get();
  public final static native int PXCCapture_Device_PROPERTY_DEPTH_FIELD_OF_VIEW_get();
  public final static native int PXCCapture_Device_PROPERTY_DEPTH_SENSOR_RANGE_get();
  public final static native int PXCCapture_Device_PROPERTY_DEPTH_FOCAL_LENGTH_get();
  public final static native int PXCCapture_Device_PROPERTY_DEPTH_PRINCIPAL_POINT_get();
  public final static native int PXCCapture_Device_PROPERTY_DEVICE_ALLOW_PROFILE_CHANGE_get();
  public final static native int PXCCapture_Device_PROPERTY_DEVICE_MIRROR_get();
  public final static native int PXCCapture_Device_PROPERTY_PROJECTION_SERIALIZABLE_get();
  public final static native int PXCCapture_Device_PROPERTY_IVCAM_LASER_POWER_get();
  public final static native int PXCCapture_Device_PROPERTY_IVCAM_ACCURACY_get();
  public final static native int PXCCapture_Device_PROPERTY_IVCAM_FILTER_OPTION_get();
  public final static native int PXCCapture_Device_PROPERTY_IVCAM_MOTION_RANGE_TRADE_OFF_get();
  public final static native int PXCCapture_Device_PROPERTY_CUSTOMIZED_get();
  ...
  public final static native int PXCCaptureManager_CUID_get();
  ...
  public final static native int PXCEmotion_CUID_get();
  ...
  public final static native int PXCFaceConfiguration_CUID_get();
  ...
  public final static native int PXCFaceConfiguration_RecognitionConfiguration_STORAGE_NAME_SIZE_get();
  ...
  public final static native int PXCFaceData_CUID_get();
  ...
  public final static native int PXCFaceData_ExpressionsData_EXPRESSION_BROW_RAISER_LEFT_get();
  ...
  public final static native int PXCFaceData_AlertData_ALERT_NEW_FACE_DETECTED_get();
  ...
  public final static native int PXCFaceModule_CUID_get();
  ...
  public final static native int PXCHandConfiguration_CUID_get();
  ...
  public final static native int PXCHandData_CUID_get();
  ...
  public final static native int PXCHandModule_CUID_get();
  ...
  public final static native int PXCImage_CUID_get();
  ...
  public final static native int PXCMetadata_CUID_get();
  ...
  public final static native int PXCPowerState_CUID_get();
  ...
  public final static native int PXCProjection_CUID_get();
  ...
  public final static native int PXCSenseManager_CUID_get();
  ...
  public final static native int PXCSession_CUID_get();
  ...
  public final static native int PXCSpeechRecognition_CUID_get();
  ...
  public final static native int PXCSpeechSynthesis_CUID_get();
  ...
  public final static native int PXCSyncPoint_CUID_get();
  ...
  public final static native int PXCTouchlessController_CUID_get();
  public final static native int PXCTouchlessController_ProfileInfo_Configuration_None_get();
  public final static native int PXCTouchlessController_ProfileInfo_Configuration_Allow_Zoom_get();
  public final static native int PXCTouchlessController_ProfileInfo_Configuration_Use_Draw_Mode_get();
  public final static native int PXCTouchlessController_ProfileInfo_Configuration_Scroll_Horizontally_get();
  public final static native int PXCTouchlessController_ProfileInfo_Configuration_Scroll_Vertically_get();
  public final static native int PXCTouchlessController_ProfileInfo_Configuration_Meta_Context_Menu_get();
  public final static native int PXCTouchlessController_ProfileInfo_Configuration_Enable_Injection_get();
  public final static native int PXCTouchlessController_ProfileInfo_Configuration_Edge_Scroll_Horizontally_get();
  public final static native int PXCTouchlessController_ProfileInfo_Configuration_Edge_Scroll_Vertically_get();
  public final static native int PXCTouchlessController_ProfileInfo_Configuration_Hide_Cursor_After_Touch_Injection_get();
  public final static native int PXCTouchlessController_ProfileInfo_Configuration_Allow_Back_get();
  ...
  public final static native int PXCTracker_CUID_get();
  ...
  public final static native int PXCVideoModule_CUID_get();
